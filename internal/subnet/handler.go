...
func (h *handler) Register(router *mux.Router) {
	router.HandleFunc("/subnets", h.GetSubnets).Methods("GET")
	router.HandleFunc("/subnets/{id}", h.GetSubnetById).Methods("GET")
	router.HandleFunc("/subnets", h.CreateSubnet).Methods("POST")
	router.HandleFunc("/subnets/{id}", h.UpdateSubnet).Methods("PUT")
	router.HandleFunc("/subnets/{id}", h.DeleteSubnet).Methods("DELETE")
}
